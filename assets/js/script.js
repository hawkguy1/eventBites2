...
var restName = '\'Nearby Resteraunts\'';
var restLocation = '123 resteraunt ave';
...
$('body').on('click', '#searchResteraunts', function() {
  ...
  $.ajax({
    ...
    startingTimeYelp = response.businesses[i].rating;
        ...
        //creates table row
        let tr = $('<form>').attr('class', 'form-items');;
        ...
        let map = $('<div>').attr('class', 'col-1 py-2 d-inline-block')
            ...
            .append($('<button>')
                ...
                // .attr('id', 'map')
                .attr('class', 'btn py-0 my-0 btn-primary max')
                .text('MAP'));
